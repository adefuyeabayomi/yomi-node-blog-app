<template>
    <div id="homepage-area">
        <div class="m-5">
            <h1 class="text-h2">Yomi Node Blog App</h1>
            <h4>Blog Admin Interface</h4>
            <p>Welcome Back, Manage Your Contents Here Now.</p>
        </div>
        <div class="divider pb-5"></div>
        <div class="container-fluid pb-5">
            <p class="text-h4-regular pb-4">Management Interface</p>
            <div class="row main-items-row justify-content-center">
                <div class="col-8 col-sm-5 m-2 col-md-3">
            ...
            <div class="ac-container-main">
                ...
                <div class="content-lists container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-12 col-sm-6 col-md-4" v-for="post in modifiedResult" :key="post.id">
